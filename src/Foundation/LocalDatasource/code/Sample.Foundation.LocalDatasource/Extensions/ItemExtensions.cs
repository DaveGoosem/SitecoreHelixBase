...
namespace Sample.Foundation.LocalDatasource.Extensions
{
    public static class ItemExtensions
    {
        ...
        public static bool IsLocalDatasourceFolderItem([NotNull] this Item dataSourceItem)
        {
            if (dataSourceItem == null) throw new ArgumentNullException(nameof(dataSourceItem));
            return dataSourceItem.TemplateID.Equals(ID.Parse(Settings.LocalDatasourceFolderTemplate));
        }
        ...
        public static bool IsLocalDatasourceItem([NotNull] this Item dataSourceItem)
        {
            ...
            if (MainUtil.IsID(Settings.LocalDatasourceFolderTemplate)) return dataSourceItem.Parent?.TemplateID.Equals(ID.Parse(Settings.LocalDatasourceFolderTemplate)) ?? false;
